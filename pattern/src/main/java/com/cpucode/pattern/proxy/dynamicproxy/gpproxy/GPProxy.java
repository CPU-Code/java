...
public class GPProxy {
    ...
    private static String generateSrc(Class<?>[] interfaces){
        ...
        sb.append("package com.cpucode.pattern.proxy.dynamicproxy.gpproxy;" + ln);
        sb.append("import com.cpucode.pattern.proxy.Person;" + ln);
        ...
        for (Method m : interfaces[0].getMethods()){
            ...
            sb.append("try{" + ln);
                sb.append("Method m = " + interfaces[0].getName() +
                        ...
                        "\",new Class[]{" + paramClasses.toString() +
                        "});" + ln);
